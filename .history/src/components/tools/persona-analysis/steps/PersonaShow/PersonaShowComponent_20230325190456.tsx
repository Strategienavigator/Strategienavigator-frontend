...
export class PersonaShowComponent extends Step<PersonaAnalysisValues, PersonaShowValues>{
    ...
    build(): JSX.Element {
        ...
        let imgSrc=baseInfoImg==""||baseInfoImg==undefined?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQZB0lAd1OrFRyoIw7hlCJ1h0Yg1itDqFMcmttlcL3Tt6KkHeN0SjeqFCavwDK54iMIPo&usqp=CAU":baseInfoImg
