...
import  "./show.scss"
import "../../../../../../public/defaultProfibild.png"
...
export class PersonaShowComponent extends Step<PersonaAnalysisValues, PersonaShowValues>{
    ...
    build(): JSX.Element {
        ...
        let imgSrc=baseInfoImg==""||baseInfoImg==undefined?"https://pic1.zhimg.com/v2-e8b0447292b8e4e5ac63802837cc03c8_b.jpg":baseInfoImg
