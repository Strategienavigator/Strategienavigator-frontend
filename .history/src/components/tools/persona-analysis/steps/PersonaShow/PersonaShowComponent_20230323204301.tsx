...
import {faSignInAlt, faHospital} from "@fortawesome/free-solid-svg-icons/";
                ...
                {/* 某一属性： 第一个页面的name:【 {this.props.save.data['persona-factors']?.factors.bedürfnisse[0].name}】 */}
                   ...
                   <Row>
                     <Col className={"childBox langBox"} sm={{span:2,offset:0}}>
                        <div className={"head"}>
                        <FAE className={"icons zitatZiel"} icon={faSignInAlt}/>Zitat
                        </div>
                        <div className={"text"}>
                         { zitat }
                        </div>
                     ...
                     <Col className={"childBox langBox withoutBorder"} sm={{span:2,offset:0}}>
                        <Row>
                           <Col className={"childBox"} sm={{span:14,offset:0}}>
                              <div className={"head"}>
                              <FAE className={"icons hobby"} icon={faSignInAlt}/> Interessen<br/>/Hobbys
                               </div>
                               <div className={"text"}>
                                { hobiese }
                               </div>
                     ...
                     <Col className={"childBox langBox withoutBorder"} sm={{span:2,offset:0}}>
                        <Row>
                           <Col className={"childBox"} sm={{span:14,offset:0}}>
                               <div className={"head"}>
                               <FAE className={"icons zitatZiel"} icon={faSignInAlt}/>Ziele<br/>/Wünsche
                               </div>
                               <div className={"text"}>
                                { motivation }
                               </div>
                        ...
                        <Row className={"untenChild"}>
                           <Col className={"childBox"} sm={{span:14,offset:0}}>
                               <div className={"head"}>
                               <FAE className={"icons prob"} icon={faSignInAlt}/>Probleme<br/>/Schmerzpunkte
                               </div>
                               <div className={"text"}>
                                {bedürfnisse}
                               </div>
                   ...
                   <Row>
                        <Col className={"childBox descriptBox"} sm={{span:8,offset:0}} >
                               <div className={"head"}>
                               <FAE className={"icons motiv"} icon={faSignInAlt}/> Welches ist das dominierende Motiv?<br/>
