...
export class PersonaShow implements StepDefinition<PersonaAnalysisValues>, StepDataHandler<PersonaAnalysisValues>  {
    ...
    // isUnlocked = (data: PersonaAnalysisValues): boolean =>    data["persona-factors"]?.factors.qualifikation!==undefined && data["persona-factors"]?.factors.qualifikation.length>0;
