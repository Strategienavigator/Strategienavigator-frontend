...
export class PersonaShowComponent extends Step<PersonaAnalysisValues, PersonaShowValues>{
    ...
    build(): JSX.Element {
        ...
        let imgSrc=baseInfoImg==""||baseInfoImg==undefined?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKQS94LP3ncwqwzBwAd9nucUYJiiA263tgZtkO1DXfHqKFTxgl6Yn4ED3okNTmm-h-4IE&usqp=CAU":baseInfoImg

        return <div>
               <div className={[isDesktop()?"getBorder":"bhjj",'test11'].join(' ')} >
                   <Row>
