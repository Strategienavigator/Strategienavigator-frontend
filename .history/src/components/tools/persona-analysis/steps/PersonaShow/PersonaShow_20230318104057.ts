...
export class PersonaShow implements StepDefinition<PersonaAnalysisValues>, StepDataHandler<PersonaAnalysisValues>  {
    ...
    isUnlocked = (data: PersonaAnalysisValues): boolean =>    data["persona-factors"]?.factors.art_der_Erkrankung!==undefined && data["persona-factors"]?.factors.art_der_Erkrankung.length>0;
