...
import {faSignInAlt, faHospital,faBullseye,faChessBoard} from "@fortawesome/free-solid-svg-icons/";
                   ...
                   <Row>
                     ...
                     <Col className={"childBox langBox withoutBorder"} sm={{span:2,offset:0}}>
                        ...
                        <Row className={"untenChild"}>
                           <Col className={"childBox"} sm={{span:14,offset:0}}>
                               <div className={"head"}>
                               <FAE className={"icons prob"} icon={faChessBoard}/>Probleme<br/>/Schmerzpunkte
                               </div>
                               <div className={"text"}>
                                {bedürfnisse}
                               </div>
