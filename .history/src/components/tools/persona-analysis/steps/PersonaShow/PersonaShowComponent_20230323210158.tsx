...
import {faSignInAlt, faHospital,faBullseye,faBug,faCoffee,faCoins,IconDefinition} from "@fortawesome/free-solid-svg-icons/";
                ...
                {/* 某一属性： 第一个页面的name:【 {this.props.save.data['persona-factors']?.factors.bedürfnisse[0].name}】 */}
                   ...
                   <Row>
                     <Col className={"childBox langBox"} sm={{span:2,offset:0}}>
                        <div className={"head"}>
                        <FAE className={"icons zitatZiel"} icon={IconDefinition}/>Zitat
                        </div>
                        <div className={"text"}>
                         { zitat }
                        </div>
