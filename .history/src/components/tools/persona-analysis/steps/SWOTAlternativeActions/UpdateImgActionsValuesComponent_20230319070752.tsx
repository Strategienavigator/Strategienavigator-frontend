                    ...
                    <Row className={"mb-3 mt-3"}>
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               ...
                               name: <input type='text' className="form-control" name = 'name' onChange={this.applyProfibildInfoChanges1.bind(this)} />
                               alter: <input type='text' className="form-control" name = 'alter' onChange={this.applyProfibildInfoChanges1.bind(this)} />          
