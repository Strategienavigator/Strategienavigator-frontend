...
export class UpdateImgActionsValues extends Step<PersonaAnalysisValues, UploadImgsState> {
                ...
                <div className={"uploadImage_actions"} >
                    <Row className={"mb-3 mt-3"}>
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               vorname: <input type='text' value={values.vorname} className="form-control" name = 'vorname' onChange={this.applyProfibildInfoChanges1.bind(this)} />
                               name: <input type='text'  value={values.name} className="form-control" name = 'name' onChange={this.applyProfibildInfoChanges1.bind(this)} />
                               alter: <input type='text'  value={values.alter} className="form-control" name = 'alter' onChange={this.applyProfibildInfoChanges1.bind(this)} />          
    ...
    applyProfibildInfoChanges1(e:any){
