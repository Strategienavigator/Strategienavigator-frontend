                ...
                <div className={"uploadImage_actions"} >
                    <Row className={"mb-3 mt-3"}>
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               vorname: <input type='text' name = 'vorname' onChange={this.applyProfibildInfoChanges1.bind(this)} />
                               name: <input type='text' name = 'name' onChange={this.applyProfibildInfoChanges1.bind(this)} />
                               alter: <input type='text' name = 'alter' onChange={this.applyProfibildInfoChanges1.bind(this)} />          
