                ...
                <div className={"uploadImage_actions"} >
                    <Row className={"mb-3 mt-3"}> 
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               profibild:<br/> <input type='file' disabled={this.props.disabled} value={values.profibild} className="form-control" name="profibild" onChange={this.handleFileChange.bind(this)}/> <br/>
            ...
            if (data !== undefined && data.factors !== undefined) {
                switch(name){
                    ...
                    case "alter":
                        ...
                        break;
                    case "profibild":
                        data.factors.profibild =this.handleFileChange.bind(e);
                        console.log("yi",this.handleFileChange.bind(e))
                        break;
