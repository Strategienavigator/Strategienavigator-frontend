                ...
                <div className={"uploadImage_actions"} >
                    <Row className={"mb-3 mt-3"}> 
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               profibild:<br/> <input type='file' disabled={this.props.disabled} value={values.profibildName} className="form-control" name="profibild" onChange={this.applyProfibildInfoChanges1.bind(this)}/> <br/>
