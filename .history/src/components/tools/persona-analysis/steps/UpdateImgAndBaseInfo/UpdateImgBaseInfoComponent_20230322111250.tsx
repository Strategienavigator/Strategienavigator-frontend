...
export class UpdateImgActionsValuesComponent extends Step<PersonaAnalysisValues, UploadImgsState> {
    ...
    handleFileChange = (e:any)=> {
        ...
        reader.onload = function() {
          ...
          e.target.name='profibild'
       
        };
        this.applyProfibildInfoChanges1.bind(e)
                ...
                <div className={"uploadImage_actions"} >
                    <Row className={"mb-3 mt-3"}> 
                         <Col sm={isDesktop() ? 6 : 12}>
                            <div>
                               profibild:<br/> <input type='file' disabled={this.props.disabled} className="form-control" name="profibild" onChange={this.handleFileChange.bind(this)}/> <br/>
