...
export class PersonaFactorsComponent extends Step<PersonaAnalysisValues, PersonaFactorsState> {
    ...
    //  After saving, disabled will be set to true
    build(): JSX.Element {
                    ...
                    <Accordion flush={true} activeKey={this.props.validationFailed ? activeKey : undefined}
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "beraterOrAngehörige"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.beraterOrAngehörigeError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "familieOrFreunde"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.familieOrFreundeError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "charaktereigenschaften"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.charaktereigenschaftenError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "bedürfnisse"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.bedürfnisseError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "hobies"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.hobiesError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
                        ...
                        <Accordion.Item eventKey={this.props.validationFailed ? activeKey : "motivation"}>
                            ...
                            <Accordion.Body>
                                ...
                                <UIErrorBanner id={"persona-analysis.motivationError"}/>
                            </Accordion.Body>
                        </Accordion.Item>
