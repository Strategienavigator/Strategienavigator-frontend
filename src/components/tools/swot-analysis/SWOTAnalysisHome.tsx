...
class SWOTAnalysisHome extends Component<any, SWOTAnalysisHomeState> {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {isDesktop() ? this.text() : this.description()}
            </ToolFrontpage>
        );
    }
    ...
    description() {
        return (
            <>
                <Button variant={"dark"} onClick={() => this.setState({show: true})} className={"description"}>Erklärung</Button>
    ...
    text() {
        return (
            <p>Eine gute SWOT-Analyse kombiniert sowohl <b>interne Einflussfaktoren</b> als auch <b>externe Einflussfaktoren</b>.
                ...
                Beispiele hierzu wären eine besonders guter Kundenservice oder eine besonders hohe Mitareitermotivation.
