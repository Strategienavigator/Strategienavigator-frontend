    ...
    render() {
        return (<>
            ...
            <p>
                ...
                Der Strategienavigator ist ein Projekt der <a href="https://www.jade-hs.de" rel="noreferrer" target="_blank">Jade Hochschule Wilhelmshaven/Oldenburg/Elsfleth</a>,
                welches größtenteils von Studenten umgesetzt und gewartet wird.

            </p>
            <p>
                <h3>Historie</h3>
                Der CRM-Navigator wurde 2007 als Open-Source-Software von Prof. Gündling initiert und 2008/09 um Strategietools erweitert.
            </p>
            <p>
                <h3>Motivation</h3>
            ...
            <h3>Links</h3>
            <p><a href="https://github.com/ricom/toolbox-frontend" rel="noreferrer" target="_blank">Frontend Repository</a></p>
            <p><a href="https://github.com/ricom/toolbox-backend" rel="noreferrer" target="_blank">Backend Repository</a></p>
            <p><a href="https://trello.com/b/3LQKqFb4/projekt-strategietools" rel="noreferrer" target="_blank">Kanbanboard</a></p>
        </>);
    }
